package com.test.greedygames.assignment.adapter;
...
import com.test.greedygames.assignment.R;
import com.test.greedygames.assignment.RecipeListActivity;
import com.test.greedygames.assignment.models.Recipe;
import com.test.greedygames.assignment.util.Constants;
import com.test.greedygames.imageloader.ImageLoader;
...
public class RecipeRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecipeRecyclerAdapter(RecipeListActivity activity) {
        this.mOnRecipeListener = activity;
        imageLoader = ImageLoader.get(activity);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (itemViewType == RECIPE_TYPE) {
            ...
            imageLoader.displayImage(mRecipes.get(i).getImage_url(), ((RecipeViewHolder) viewHolder).image);
            ...
            ((CategoryViewHolder) viewHolder).categoryImage.setImageResource(Constants.DEFAULT_SEARCH_CATEGORY_IMAGES_DRAWABLE[i]);
